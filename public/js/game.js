...
(function() {
  var Board, Cell, NewBallsBoard, Scoreboard;
  ...
  NewBallsBoard = (function() {
    ...
    class NewBallsBoard {
      ...
      addNewCircles() {
        var i, randomCell, randomCellIndex, randomColor, randomColorIndex, results;
        i = 0;
        results = [];
        // Add the predefined number of new circles.
        while (i++ < this.newCirclesNum) {
          ...
          // Put the circle into the cell.
          randomCell.show(randomColor, true);
          results.push(console.log('Novas bolas=', randomCellIndex, randomColor));
        }
        return results;
      }
